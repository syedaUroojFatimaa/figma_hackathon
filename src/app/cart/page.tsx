  ...
  return (
    <div>
      ...
      <div className="bg-gray-100 w-full px-4 sm:px-10 lg:px-40 pt-10 pb-16 h-auto text-custom-purple">
        <h1 className="text-4xl sm:text-3xl text-center lg:text-left">
          Your Shopping Cart
        </h1>
        ...
        <div className="flex ml-10 pt-5">
                ...
                <div className="ml-6">
                  ...
                  <p className="text-sm mt-2">
                    A timeless ceramic vase with a tri-color grey 
                  </p>
                  <p className="text-sm">glaze.</p>
          ...
          <h1 className="inline text-lg sm:text-xl font-normal mr-2">
            Subtotal
          </h1>
          ...
          <button className="bg-violet-950 h-12 sm:h-14 mt-6 w-full sm:w-56 rounded-sm text-white">
            Go to checkout
          </button>
